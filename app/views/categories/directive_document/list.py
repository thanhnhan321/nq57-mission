...
class DirectiveDocumentListPartialView(ListView):
    model = DirectiveDocument
    template_name = "categories/directive_document/partial.html"
...
class DirectiveDocumentListView(DirectiveDocumentListPartialView):
    model = DirectiveDocument
    template_name = "categories/directive_document/list.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['breadcrumbs'] = f'Danh mục / <a href="{reverse("directive_document_list")}" class="hover:underline">Văn bản chỉ đạo</a>'
        return context
