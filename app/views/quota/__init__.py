...
from .delete import QuotaDeleteConfirmView, QuotaDeleteView
...
from .template_download import QuotaTemplateDownloadView
from .unlock_lock_period import quota_period_toggle_confirm, quota_period_toggle
...
urlpatterns = [
    ...
    path('delete-confirm/', QuotaDeleteConfirmView.as_view(), name='quota_delete_confirm'),
    ...
    path("template/download/", QuotaTemplateDownloadView.as_view(), name="quota_template_download",),
    path("period-toggle/confirm/", quota_period_toggle_confirm, name="quota_period_toggle_confirm",),
    path("period-toggle/", quota_period_toggle, name="quota_period_toggle",
),
]